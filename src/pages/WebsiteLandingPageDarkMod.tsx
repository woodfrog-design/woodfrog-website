  ...
  return (
    <div className={styles.websiteLandingPageDarkMod}>
      ...
      <div className={styles.heroGraphic}>
        <div ref={heroGraphicRef} className={styles.heroGraphicChild} />
...
// Install commands
// npm install react react-dom gsap @netlify/functions node-fetch
// npm install --save-dev @types/react @types/react-dom @types/node

// Example for UnOrderListOnly.tsx
type UnOrderListOnlyProps = {
  list?: string[];
};
