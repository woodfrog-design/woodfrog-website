...
const ContentSection: FunctionComponent<ContentSectionProps> = ({ section, index }) => {
  ...
  if (section.cardLayout && section.cards) {
    return (
      <section
        className={`${styles.contentSection} ${index % 2 === 0 ? styles.bgLight : styles.bgFaint}`}
      >
  ...
  return (
    ...
    >
      <div
        className={`${styles.sectionContainer} ${isImageLeft ? styles.imageLeft : styles.imageRight}`}
      >
          ...
          {section.subSection && (
            <div className={styles.subSection}>
              <div
                ...
                dangerouslySetInnerHTML={{ __html: section.subSection.description }}
              />
...
const ClosingSection: FunctionComponent<ClosingSectionProps> = ({ closing }) => (
  <section className={styles.closingSection}>
    <div
      className={`${styles.sectionContainer} ${closing.imagePosition === 'left' ? styles.imageLeft : styles.imageRight}`}
    >
      <div className={styles.textContent}>
  ...
  return (
    <div className={styles.aboutUsPage}>
      ...
      <main className={styles.mainContent}>
        <PageHero title={aboutUsData.header.title} description={aboutUsData.header.description} />
