...
export const offeringData = {
  hero: {
    ...
    description:
      'Woodfrog provides cutting-edge data science and AI solutions that transform raw information into strategic business advantages.',
  ...
  categories: [
    {
      ...
      description:
        'We combine industry expertise with advanced data science capabilities to help you uncover opportunities, optimize operations, and make informed decisions.',
    ...
    },
    {
      ...
      description:
        'Harness the revolutionary power of LLMs and AI agents to automate complex tasks, unlock insights, and transform your business operations.',
    ...
    cases: [
      {
        ...
        description:
          'Helped a retail chain improve inventory forecasting accuracy by 22% and reduce out-of-stock instances by 35% through advanced predictive analytics.',
        image: '/images/RetailAnalytics/ra.png',
      },
      {
        industry: 'Healthcare Operations',
        description:
          'Developed a patient flow optimization system that reduced average wait times by 40% and improved resource allocation for a major healthcare provider.',
        image: '/images/Healthcare/hc.png',
      },
      {
        industry: 'Financial Services',
        description:
          'Created a custom LLM solution that automated document processing and reduced manual review time by 70% while maintaining strict compliance standards.',
        image: '/images/Finance/finance.jpg',
      },
      {
        industry: 'Manufacturing',
        description:
          'Implemented a predictive maintenance system that decreased unplanned downtime by 27% and extended equipment lifespan by an estimated 15-20%.',
    ...
    steps: [
      {
        ...
        title: 'Discovery',
        description:
          'We begin by understanding your business, challenges, and objectives through in-depth consultation.',
      },
      {
        number: '02',
        title: 'Assessment',
        description:
          'Our team analyzes your data landscape, identifies opportunities, and creates a tailored strategy.',
      },
      {
        number: '03',
        title: 'Development',
        description:
          'We build and refine customized solutions aligned with your specific business needs.',
      },
      {
        number: '04',
        title: 'Implementation',
        description:
          'Solutions are seamlessly integrated into your operations with minimal disruption.',
      },
      {
        number: '05',
        title: 'Optimization',
        description:
          'We continuously monitor, analyze, and improve performance to maximize long-term value.',
      },
    ],
  },
};
...
const FeatureCard: FunctionComponent<FeatureCardProps> = ({ feature }) => (
  <Link to={feature.link} className={styles.featureCard}>
    <div className={styles.featureImageWrapper}>
      ...
      />
      {feature.icon && <div className={styles.featureIcon}>{getIconComponent(feature.icon)}</div>}
    </div>
...
const CategorySection: FunctionComponent<CategorySectionProps> = ({ category, index }) => (
  <section
    className={`${styles.categorySection} ${index % 2 === 0 ? styles.evenSection : styles.oddSection}`}
  >
    <div className={styles.categoryContainer}>
      <CategoryOverview category={category} isReversed={index % 2 !== 0} />
    ...
    <section className={`${styles.ctaSection} ${isDarkTheme ? styles.ctaSectionDark : ''}`}>
      ...
      <div className={styles.ctaContainer}>
        ...
        <p className={styles.ctaDescription}>
          Let's discuss how our data science expertise and AI capabilities can drive innovation and
