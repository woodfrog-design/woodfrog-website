    ...
    <section className={styles.TermsAndConditions}>
      ...
      <main className={styles.body}>
        <div className={styles.pageDescriptionWrapper}>
          <PageDescription data-aos="fade-in" data-aos-duration="4000" details={termsDescription} />
        </div>
        ...
        <div className={styles.contentContainer}>
          <div className={styles.contentWrapper}>
            <section className={styles.section}>
              ...
              <p>
                Welcome to <strong>Woodfrog Tech</strong>. These terms and conditions outline the
                rules and regulations for the use of our website and services. By accessing this
                website, we assume you accept these terms and conditions in full. Do not continue to
                use Woodfrog Tech's website if you do not accept all the terms and conditions stated
                here.
              </p>
            </section>
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                are reserved. You may access this from Woodfrog Tech for your own personal use,
            ...
            <section className={styles.section}>
              ...
              <p>
                ...
                website signifies acceptance of any modifications.
              </p>
            </section>
