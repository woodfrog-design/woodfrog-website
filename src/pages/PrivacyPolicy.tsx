      ...
      <main className={styles.body}>
        ...
        <div className={styles.contentContainer}>
          <div className={styles.contentWrapper}>
            <p>
              At <strong>Woodfrog Tech</strong>, we value your privacy and are committed to
            ...
            <p>
              ...
              However, no system is completely secure. We recommend using strong passwords and
            ...
            <p>
              To exercise these rights, contact us at <strong>info@woodfrog.tech</strong>.
            </p>
            ...
            <ul>
              ...
              <li>
                Opt-out of the sale of personal data (Woodfrog Tech does not sell personal data)
              </li>
            </ul>

            <h2>6. Cloud Computing and Data Storage</h2>
            <p>
              Our services operate on secure cloud infrastructure, ensuring high availability and
              compliance with data protection laws.
            </p>

            <h2>7. Client Data Sharing & Third-Party Services</h2>
            <p>
              We may share data with trusted third-party providers to enhance services. However, we
              do not sell client data, and all integrations follow strict data protection protocols.
            </p>

            <h2>8. Cookies & Tracking Technologies</h2>
            <p>
              We use cookies to enhance your experience. You can manage cookies in your browser
              settings.
            </p>
            ...
            <p>
              ...
              <a href="mailto:info@woodfrog.tech" className={styles.email}>
                info@woodfrog.tech
              </a>
              .
            </p>
