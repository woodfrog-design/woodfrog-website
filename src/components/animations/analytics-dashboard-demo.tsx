...
const Dashboard: React.FC<{
    ...
    return (
        <div className="flex w-full h-full bg-[#fcfdfe] text-slate-800 overflow-hidden relative" style={{ fontFamily: 'var(--font-geist-sans)' }}>
            ...
            {/* ── Main Content ── */}
            <main className="flex-1 p-6 flex flex-col gap-4 overflow-hidden min-w-0 relative z-10">
                {/* Top Filter Bar */}
                ...
                <div className="flex-1 grid grid-cols-12 grid-rows-[auto_1fr_1fr_auto] gap-2 min-h-0">
                    ...
                    <div className="col-span-12 grid grid-cols-2 lg:grid-cols-3 2xl:grid-cols-6 gap-3">
                    ...
                    <div className="col-span-12 lg:col-span-6 bg-white/70 backdrop-blur-md rounded-3xl border border-white/40 p-4 flex flex-col shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:bg-white/80 transition-all">
                        <div className="flex items-center justify-between mb-2.5">
                            ...
                            <div className="flex bg-slate-100/50 backdrop-blur-sm rounded-xl p-0.5 gap-1">
                                ...
                                >
                                    ...
                                    <div className="flex-1 h-2.5 bg-slate-100 rounded-full overflow-hidden relative">
                                        <motion.div
                                            ...
                                            style={{
                                                background: `linear-gradient(90deg, ${ANIMATION_THEME.primary}, ${ANIMATION_THEME.primary}CC)`,
                                            }}
                                        >
                                            <div className="absolute inset-0 bg-white/20 animate-pulse" style={{ width: '50px' }} />
                                        </motion.div>
                                    </div>
...
export const AnalyticsDashboardDemo: React.FC<{ isActive?: boolean }> = ({ isActive = true }) => {
