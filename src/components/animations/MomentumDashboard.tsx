        ...
        <div className="flex w-full h-full bg-white text-slate-800 overflow-hidden" style={{ fontFamily: 'var(--font-geist-sans)' }}>
            ...
            <main className="flex-1 p-4 flex flex-col gap-3 bg-[#fafbfc] overflow-hidden">
                ...
                <div className="grid grid-cols-3 gap-2.5 shrink-0">
                    {[
                        { icon: <Rocket size={16} />, title: 'Rapid Deployment', desc: 'Prototype to production in weeks with automated CI/CD and blue-green deploys.', bg: 'bg-blue-50', text: 'text-blue-500' },
                            ...
                            {milestones.map((m, i) => (
                                <div key={i} className="flex gap-2.5">
                                    ...
                                    <div className="pb-2">
                                        ...
                                        <span className={`text-[7px] font-medium mt-0.5 inline-block px-1.5 py-0.5 rounded-full ${
