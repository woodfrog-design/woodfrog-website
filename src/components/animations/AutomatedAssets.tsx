...
export const HighlightBox: React.FC = () => {
    return (
        <motion.div
            ...
            className="bg-[#1f1f1f] p-6 rounded-[16px] shadow-2xl flex flex-col gap-2 min-w-[200px] border border-gray-800"
        >
            ...
            <div className="flex items-center gap-2 mt-1">
                ...
                <span className="text-green-400 text-sm font-medium">+32% vs 1982 Cycle</span>
            </div>
        </motion.div>
    );
};
                    ...
                    {isClicking && (
                        <>
                            <motion.div
                                ...
                                className="absolute top-0 left-0 w-5 h-5 rounded-full border-2 border-blue-400"
                            />
                            <motion.div
                                ...
                                className="absolute top-0.5 left-0.5 w-4 h-4 bg-blue-400/30 rounded-full"
                            />
                        </>
                    )}
                </AnimatePresence>
