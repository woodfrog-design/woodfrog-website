...
const ServicesContent: FunctionComponent<ServicesContentType> = ({ className = '' }) => {
  ...
  return (
    <section className={[styles.servicesContent, className].join(' ')}>
      <h1 ref={coreServicesRef} className={[styles.coreServices].join(' ')}>
        Core Services
      </h1>
          ...
          <div className="mb-4 flex-grow-1">
            <div className={['card h-100', styles.cardBack].join(' ')}>
              <div className="card-body d-flex flex-column">
                ...
                <img
                  src={isDarkTheme ? './arrow-dark.svg' : './arrow-light.svg'}
                  className={[styles.imageMarginBottom, 'img-fluid'].join(' ')}
                  alt=""
                />
                <div className="mt-auto">
                  <div className={styles.efficientlyManageAnd}>
                    Efficiently manage and transform your data pipelines, ensuring data is clean,
                    organized, and ready for advanced analytics.
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className={['card-body d-flex flex-column', styles.relativePosition].join(' ')}>
                ...
                <div className="mt-auto">
                  <div className={styles.efficientlyManageAnd}>
                    ...
                    seamless deployment, monitoring, and scalability.
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-4 flex-grow-1">
            <div className={['card h-100', styles.cardBack].join(' ')}>
              <div className="card-body d-flex flex-column">
                ...
                <img
                  src={isDarkTheme ? './analytics-dark.svg' : './analytics-light.svg'}
                  className={[styles.imageMarginBottom, 'img-fluid'].join(' ')}
                  alt=""
                />
                <div className="mt-auto">
                  <div className={styles.efficientlyManageAnd}>
                    Gain actionable insights through data-driven analytics that empower smarter,
          ...
          <div className="mb-3 flex-grow-1">
            <div className={['card h-100', styles.cardBack].join(' ')}>
              <div className="card-body d-flex flex-column">
                ...
                <img
                  src={isDarkTheme ? './LLM-dark.svg' : './LLM-light.svg'}
                  style={{ height: isDarkTheme ? '' : '192px' }}
                  className={[styles.imageMarginBottom, 'img-fluid'].join(' ')}
                  alt=""
                />
                <div className="mt-auto">
                  <div className={styles.efficientlyManageAnd}>
                    Manage and operationalize large language models efficiently, ensuring seamless
                    integration and performance across applications.
                  </div>
                </div>
              </div>
            </div>
