    ...
    return (
        ...
        >
            <div className="flex items-center justify-between w-full px-5 md:px-6 py-4 md:py-3 pointer-events-auto transition-all duration-300 cursor-default bg-transparent md:backdrop-blur-none md:border-none">
                {/* Logo */}
                <Link href="/" className="flex-shrink-0 flex items-center cursor-pointer" onClick={() => { setIsServicesOpen(false); setIsWoodfrogOpen(false); setIsMobileMenuOpen(false); }}>
                    <svg width="112" height="24" viewBox="0 0 112 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-[100px] md:w-[140px] h-auto transition-all">
                        ...
                        <path d="M76.8386 13.444C76.8386 13.9719 76.9193 14.4632 77.0806 14.9178C77.2419 15.3577 77.4692 15.739 77.7625 16.0617C78.0558 16.3696 78.4151 16.6189 78.8403 16.8096C79.2656 16.9855 79.7422 17.0735 80.2701 17.0735C80.7981 17.0735 81.2747 16.9855 81.6999 16.8096C82.1252 16.6189 82.4845 16.3696 82.7778 16.0617C83.0711 15.739 83.2984 15.3577 83.4597 14.9178C83.621 14.4632 83.7016 13.9719 83.7016 13.444C83.7016 12.9161 83.621 12.4321 83.4597 11.9922C83.2984 11.5376 83.0711 11.1563 82.7778 10.8483C82.4845 10.5257 82.1252 10.2764 81.6999 10.1004C81.2747 9.90976 80.7981 9.81444 80.2701 9.81444C79.7422 9.81444 79.2656 9.90976 78.8403 10.1004C78.4151 10.2764 78.0558 10.5257 77.7625 10.8483C77.4692 11.1563 77.2419 11.5376 77.0806 11.9922C76.9193 12.4321 76.8386 12.9161 76.8386 13.444ZM74.7269 13.444C74.7269 12.6814 74.8662 11.9702 75.1449 11.3103C75.4382 10.6503 75.8341 10.0711 76.3327 9.57247C76.8313 9.07387 77.4179 8.68525 78.0924 8.40662C78.767 8.11332 79.4929 7.96667 80.2701 7.96667C81.0473 7.96667 81.7732 8.11332 82.4478 8.40662C83.1224 8.68525 83.709 9.07387 84.2076 9.57247C84.7062 10.0711 85.0948 10.6503 85.3734 11.3103C85.6667 11.9702 85.8133 12.6814 85.8133 13.444C85.8133 14.2066 85.6667 14.9251 85.3734 15.5997C85.0948 16.2596 84.7062 16.8389 84.2076 17.3375C83.709 17.8214 83.1224 18.21 82.4478 18.5033C81.7732 18.782 81.0473 18.9213 80.2701 18.9213C79.4929 18.9213 78.767 18.782 78.0924 18.5033C77.4179 18.21 76.8313 17.8214 76.3327 17.3375C75.8341 16.8389 75.4382 16.2596 75.1449 15.5997C74.8662 14.9251 74.7269 14.2066 74.7269 13.444Z" fill="white" />
                        ...
                        <path d="M33.491 13.444C33.491 13.9719 33.5716 14.4632 33.7329 14.9178C33.8942 15.3577 34.1215 15.739 34.4148 16.0617C34.7081 16.3696 35.0674 16.6189 35.4927 16.8096C35.918 16.9855 36.3946 17.0735 36.9225 17.0735C37.4504 17.0735 37.927 16.9855 38.3523 16.8096C38.7775 16.6189 39.1368 16.3696 39.4301 16.0617C39.7234 15.739 39.9507 14.9178 40.112 14.9178C40.2733 14.4632 40.354 13.9719 40.354 13.444C40.354 12.9161 40.2733 12.4321 40.112 11.9922C39.9507 11.5376 39.7234 11.1563 39.4301 10.8483C39.1368 10.5257 38.7775 10.2764 38.3523 10.1004C37.927 9.90976 37.4504 9.81444 36.9225 9.81444C36.3946 9.81444 35.918 9.90976 35.4927 10.1004C35.0674 10.2764 34.7081 10.5257 34.4148 10.8483C34.1215 11.1563 33.8942 11.5376 33.7329 11.9922C33.5716 12.4321 33.491 12.9161 33.491 13.444ZM31.3793 13.444C31.3793 12.6814 31.5186 11.9702 31.7972 11.3103C32.0905 10.6503 32.4864 10.0711 32.985 9.57247C33.4836 9.07387 34.0702 8.68525 34.7448 8.40662C35.4194 8.11332 36.1453 7.96667 36.9225 7.96667C37.6997 7.96667 38.4256 8.11332 39.1002 8.40662C39.7747 8.68525 40.3613 9.07387 40.8599 9.57247C41.3585 10.0711 41.7471 10.6503 42.0257 11.3103C42.319 11.9702 42.4657 12.6814 42.4657 13.444C42.4657 14.2066 42.319 14.9251 42.0257 15.5997C41.7471 16.2596 41.3585 16.8389 40.8599 17.3375C40.3613 17.8214 39.7747 18.21 39.1002 18.5033C38.4256 18.782 37.6997 18.9213 36.9225 18.9213C36.1453 18.9213 35.4194 18.782 34.7448 18.5033C40.3613 18.21 33.4836 17.8214 32.985 17.3375C32.4864 16.8389 32.0905 16.2596 31.7972 15.5997C31.5186 14.9251 31.3793 14.2066 31.3793 13.444Z" fill="white" />
                        ...
                        <path d="M103.568 0.458252L100.361 7.17951H102.041L104.179 2.44408L106.318 7.17951H108.151L104.791 0.458252H103.568Z" fill="var(--brand-primary)" stroke="var(--brand-primary)" strokeWidth="0.305512" />
                    </svg>
                </Link>
