        ...
        >
          <div className={styles.logoContainer}>
            ...
            <nav className={styles.menu}>
              <ThemePreservingLink to="/blog" className={styles.ourSolutions}>
                Blogs
              </ThemePreservingLink>
              <ThemePreservingLink to="/offering" className={styles.ourSolutions}>
                Offering
              </ThemePreservingLink>
              <ThemePreservingLink to="/about-us" className={styles.ourSolutions}>
                About Us
              </ThemePreservingLink>
              <ThemePreservingLink to="/contact-us" className={styles.ourSolutions}>
                Contact Us
              </ThemePreservingLink>
            </nav>
            <ModeToggle />
            ...
            <div className="row m-0">
              <div className="col-12 p-0">
                <ul className={styles.menus}>
                  <li>
                    <ThemePreservingLink to="/blog" onClick={() => setShow(false)}>
                      Blogs
                    </ThemePreservingLink>
                  </li>
                  <li>
                    <ThemePreservingLink to="/offering" onClick={() => setShow(false)}>
                      Offering
                    </ThemePreservingLink>
                  </li>
                  <li>
                    <ThemePreservingLink to="/about-us" onClick={() => setShow(false)}>
                      About Us
                    </ThemePreservingLink>
                  </li>
                  <li>
                    <ThemePreservingLink to="/contact-us" onClick={() => setShow(false)}>
                      Contact Us
                    </ThemePreservingLink>
                  </li>
                </ul>
