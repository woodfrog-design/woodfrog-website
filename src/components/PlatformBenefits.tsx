...
const PlatformBenefits: FunctionComponent<PlatformBenefitsType> = ({ className = '' }) => {
    ...
    <section ref={sectionRef} className={[styles.platformBenefitsContainer].join(' ')}>
      <div className="row">
        <div className="col-12 p-0">
          <h1 ref={ourStrengthsRef} className={styles.platformBenefitsTitle}>
            Our Strengths
          </h1>
        </div>
      </div>
      <div className="row">
        <div className={['col-12 col-sm-12 col-md-4 p-0'].join(' ')}>
          <div className={styles.platformBenefitsDescription}>
            <p>
              {' '}
              Experience the Speed, Accuracy, and Impact of Eagle Eagle sets a new standard in data
              processing with unmatched speed and accuracy, empowering your organization to perform
              analytics in record time. By delivering precise insights with lightning-fast results,
              our platform enables you to stay ahead of the competition. Whether you're streamlining
              operations or optimizing decision-making, Eagle helps you reduce operational costs,
              improve efficiency, and drive tangible business outcomes. Experience a seamless,
              data-driven transformation with a platform built for performance and measurable
              success.
            </p>
          </div>
        </div>
          ...
          <div className="row m-0">
            <div className={['col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 p-0 '].join(' ')}>
              <div className={[styles.box, styles.borderRight].join(' ')}>
                <div className={[styles.boxTitle].join(' ')}>
                  {isVisible && countdown ? <CountUp end={10} duration={2} suffix="x" /> : '10x'}
                </div>
                <div className={[styles.boxContent].join(' ')}>
                  Faster Data Processing & Analytics
                </div>
              </div>
            </div>
            <div className={['col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 p-0 '].join(' ')}>
            ...
            <div className={['col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 p-0 '].join(' ')}>
              <div className={[styles.box, styles.borderLeft].join(' ')}>
                ...
                <div className={[styles.boxContent].join(' ')}>
                  Achieve near-perfect data Accuracy
                </div>
              </div>
            </div>
          </div>
        ...
        {/* Mobile view */}
        <div
          className={['col-12 col-sm-12 col-md-8 col-lg-8 mt-4 mb-4', 'd-block d-sm-none '].join(
            ' ',
          )}
        >
          <div className="row m-0">
