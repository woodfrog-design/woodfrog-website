        ...
        <div className={styles.features}>
          {[
            ...
            <div key={index} className={styles.list1} ref={(el) => (cardsRef.current[index] = el!)}>
              ...
              <div className={styles.unmatchedRoiParent}>
                <h3 className={styles.comprehensiveEndToEndSolut}>{feature.title}</h3>
                <div className={styles.ourExpertTeam}>{feature.description}</div>
              </div>
            </div>
          ))}
        </div>
        <div className={styles.buttonContainer}>
          <div className={styles.buttonWrapper}>
            <div className={styles.pOCButton} onClick={() => setIsModalVisible(true)}>
              <div onClick={handleformscroll} className={styles.getAFree}>
                Get a Free POC
              </div>
            </div>
          </div>
