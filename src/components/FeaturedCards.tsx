...
const FeaturedCards: FunctionComponent<FeaturedCardsType> = ({
  ...
  return (
    <div className={[styles.featuredCards, className].join(' ')} style={featuredCardsStyle}>
      ...
      <div className={styles.cardContent}>
        <div className={styles.cardFooter}>
          ...
          <div className={styles.cardTitle}>
            <h2 className={styles.enablingNextGenDigital}>Enabling next-gen digital expericence</h2>
