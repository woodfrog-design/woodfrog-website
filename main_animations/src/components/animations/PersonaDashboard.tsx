...
const modelPerformance = [
    { name: 'GPT-4o Fine-tuned', value: 94.2, color: ANIMATION_THEME.primary },
    { name: 'Predict-v4.1', value: 88.7, color: '#f59e0b' },
    { name: 'Vision-X Pro', value: 76.3, color: ANIMATION_THEME.text.primary },
    { name: 'Agent-Core v2', value: 91.5, color: ANIMATION_THEME.accent.success }
];
                ...
                <div className="grid grid-cols-2 gap-3 flex-1 min-h-0">
                    ...
                    <div className="bg-white border border-gray-100 rounded-xl p-4 flex flex-col">
                        <div className="flex justify-between items-center mb-3 shrink-0">
                            ...
                            <button className="px-3 py-1.5 rounded-lg text-[9px] font-medium" style={{ backgroundColor: ANIMATION_THEME.primary, color: ANIMATION_THEME.text.primary }}>
                                Optimize
                            </button>
                        </div>
