  ...
  >
    <div className="relative">
      <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
        ...
        <rect x="11" y="8" width="5" height="16" rx="1.5" fill="#f59e0b" />
...
const WavyDecoration = () => (
  <div className="absolute inset-0 pointer-events-none overflow-hidden">
    ...
    <svg className="absolute top-[35%] left-[10%] w-[80%] opacity-[0.15]" viewBox="0 0 600 120" fill="none">
      <path d="M0 60 C80 20, 160 100, 240 60 C320 20, 400 100, 480 60 C560 20, 600 60, 600 60" stroke={ANIMATION_THEME.primary} strokeWidth="3.5" fill="none" />
      <path d="M0 75 C80 35, 160 115, 240 75 C320 35, 400 115, 480 75 C560 35, 600 75, 600 75" stroke={ANIMATION_THEME.border} strokeWidth="2.5" fill="none" />
    </svg>
    {/* Secondary subtle wave lower */}
    <svg className="absolute top-[50%] left-[5%] w-[90%] opacity-[0.08]" viewBox="0 0 600 80" fill="none">
      <path d="M0 40 C100 10, 200 70, 300 40 C400 10, 500 70, 600 40" stroke={ANIMATION_THEME.text.primary} strokeWidth="4" fill="none" />
    </svg>
    {/* Subtle radial glow spots */}
    <div className="absolute top-[30%] left-[20%] w-32 h-32 bg-orange-200/20 rounded-full blur-3xl" />
  ...
  <div className="absolute inset-0 bg-[#f0ebe0] flex flex-col">
    ...
    <div className="bg-white border-b border-slate-200/60 px-6 py-3 flex items-center gap-3">
      <div className="w-6 h-6 rounded flex items-center justify-center" style={{ backgroundColor: `${ANIMATION_THEME.primary}1A` }}>
        <Search size={12} style={{ color: ANIMATION_THEME.primary }} />
      </div>
        ...
        <div className="flex items-start gap-3">
          <div className="w-8 h-8 rounded-lg flex items-center justify-center shrink-0" style={{ backgroundColor: `${ANIMATION_THEME.primary}1A` }}>
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <circle cx="12" cy="12" r="9" stroke={ANIMATION_THEME.primary} strokeWidth="2" />
              <path d="M12 7v5l3 3" stroke={ANIMATION_THEME.primary} strokeWidth="2" strokeLinecap="round" />
            </svg>
          </div>
          <div className="flex-1 min-w-0">
          ...
          <motion.div key="search" className="absolute inset-0 bg-[#f0ebe0]" {...pageTransition}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              >
                ...
                >
                  <Search size={16} style={{ color: ANIMATION_THEME.primary }} />
                </button>
              </div>
            </div>
          </motion.div>
