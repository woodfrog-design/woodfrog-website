    ...
    return (
        <div className="flex flex-col w-full h-full bg-white text-slate-800 overflow-hidden" style={{ fontFamily: 'var(--font-geist-sans)' }}>
            ...
            <header className="bg-white border-b border-gray-100 px-5 py-3 flex justify-between items-center shrink-0">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <div className="flex items-center gap-2">
                            <h2 className="text-[14px] font-semibold tracking-tight" style={{ color: ANIMATION_THEME.text.primary }}>Eagle Engine</h2>
                            <span className="px-1.5 py-0.5 rounded text-[8px] font-medium" style={{ backgroundColor: `${ANIMATION_THEME.primary}33`, color: ANIMATION_THEME.text.primary }}>Performance Detail</span>
                        </div>
                ...
                <div className="flex items-center gap-2">
                    <div className="flex bg-slate-50 rounded-md p-0.5 gap-0.5 border" style={{ borderColor: ANIMATION_THEME.border }}>
                        <div className="px-2.5 py-1 rounded shadow-sm text-[9px] font-medium flex items-center gap-1.5 border" style={{ backgroundColor: ANIMATION_THEME.background, color: ANIMATION_THEME.text.primary, borderColor: ANIMATION_THEME.border }}>
                            <Activity size={10} style={{ color: ANIMATION_THEME.primary }} />
                            Live Telemetry
                        </div>
                ...
                <div className="grid grid-cols-12 gap-3 flex-1 min-h-0">
                        ...
                        <div className="flex justify-between items-center mb-2 shrink-0">
                            ...
                            <div className="flex gap-3">
                                <div className="flex items-center gap-1.5">
                                    <div className="w-2 h-2 rounded-full" style={{ backgroundColor: ANIMATION_THEME.primary }} />
                    ...
                    <div className="col-span-4 flex flex-col gap-3">
                        <div className="bg-white border border-gray-100 rounded-xl p-3.5 flex-1 flex flex-col">
                            <div className="flex justify-between items-center mb-2 shrink-0">
                                <h3 className="text-[11px] font-semibold" style={{ color: ANIMATION_THEME.text.primary }}>Node Registry</h3>
                                <button className="text-[8px] font-medium flex items-center gap-0.5" style={{ color: ANIMATION_THEME.primary }}>
                                ...
                                {nodeStatus.map((node, i) => (
                                    <div key={i} className="p-2.5 rounded-lg bg-slate-50 border border-slate-100 cursor-pointer group">
                                        <div className="flex justify-between items-center mb-1">
                                            <span className="text-[9px] font-semibold text-slate-800 group-hover:underline transition-colors" style={{ textDecorationColor: ANIMATION_THEME.primary }}>{node.id}</span>
                                            <span className={`text-[7px] font-medium px-1.5 py-0.5 rounded-full ${node.status === 'Stable' ? 'bg-emerald-50 text-emerald-600' :
                        ...
                        <div className="bg-slate-900 rounded-xl p-3.5 text-white relative overflow-hidden shrink-0">
                            <div className="absolute top-0 right-0 w-24 h-24 blur-[60px] opacity-20 -mr-8 -mt-8" style={{ backgroundColor: ANIMATION_THEME.primary }} />
                            <div className="relative z-10">
                                <span className="text-[8px] font-medium uppercase tracking-wider" style={{ color: ANIMATION_THEME.primary }}>Operational Readiness</span>
                                ...
                                <div className="mt-2.5 flex items-center gap-3">
                                    <div className="h-9 w-9 rounded-lg bg-white/10 flex items-center justify-center backdrop-blur-md border border-white/10">
                                        <TrendingUp size={16} style={{ color: ANIMATION_THEME.primary }} />
                                    </div>
                                    <div>
