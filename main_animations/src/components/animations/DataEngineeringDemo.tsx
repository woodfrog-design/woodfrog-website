...
export const DataEngineeringDemo: React.FC = () => {
    ...
    useEffect(() => {
        ...
        const timer = setTimeout(runSequence, 400);
        return () => { cancelled = true; clearTimeout(timer); };
    }, [cursorX, cursorY, getElementCenter]);
    ...
    return (
        <div ref={containerRef} className="relative w-full h-full overflow-hidden bg-[#fcfdfe]" style={{ fontFamily: 'var(--font-geist-sans)' }}>
            {/* Background blurs */}
